import type { TCartItem, TGuitarID } from "../types";
...
export default function Header({ cart, removeFromCart, increaseQuantity, decreaseQuantity, cleanCart, isCartEmpty, totalPrice }: HeaderProps) {
